                ...
                <AccountCardRight>
                    <AccountCardContent>
                        ...
                        <AccountCardContentItem>
                            ...
                            <div>
                                <Button color='blue' onClick={() => this.props.onCopyKey(defaultAccount)}>COPY PRIVATE KEY</Button>
                            </div>
                        </AccountCardContentItem>
                    </AccountCardContent>
                </AccountCardRight>
        ...
        const accountsItem = accounts.filter(a => a.address !== defaultAccount).map(account => (
            <AccountCard key={account.address}>
                <AccountCardLeft>
                    ...
                    <Button color='ogange' style={{fontSize: 14}}
                        ...
                        <AccountCardContentItem>
                            ...
                            <div>
                                <div>
                                    ...
                                    <Button color='blue' onClick={() => this.props.onCopyKey(account.address)}>COPY PRIVATE KEY</Button>
                                </div>
                            </div>
        ...
        return (
            <div>
                ...
                <CreateButtonContainer>
                    <Button color='blue' onClick={ this.create }>CREATE NEW</Button>
                </CreateButtonContainer>
            </div>
        );
    }
